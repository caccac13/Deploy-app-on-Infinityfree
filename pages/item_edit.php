...
?>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <textarea name="itemname" id="itemname" require><?php echo $row['itemname']; ?></textarea><br>
            <?php
            ...
            <textarea name="description" id="description" rows="4" require><?php echo $row['description']; ?></textarea><br>
            <br>

            <label for="unit">Unit:</label><br>
            <input type="text" name="unit" id="unit" value="<?php echo $row['unit']; ?>" require><br>
            <br>

            <label for="price">Price:</label><br>
            <input type="text" name="price" id="price" value="<?php echo $row['price']; ?>" require><br>
            <br>
            ...
            ?><br>
            <input style="margin-bottom: 40px;" class="btn btn-primary" type="submit" value="Ok">
        </form>
